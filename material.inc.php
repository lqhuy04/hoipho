...
$this->langitem = [
    ...
    'second_highest_card_played' => clienttranslate('${player_name} played the second highest card (${reputation}) and gains ${coin_amount} coin'),
    'lowest_card_played'         => clienttranslate('${player_name} played the lowest card (${reputation}) and activates its skill:'),
    'one_ship_played'            => clienttranslate('${player_name} played the only Merchant Ship and gains 5 coins'),
