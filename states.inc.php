...
$machinestates = [
    ...
    STATE_SETUP_NEW_ROUND => [
        ...
        "transitions"           => [
            ...
            "actSelectCard"     => STATE_SELECT_CARD,
        ],
    ],
    ...
    STATE_REVEAL_DISCARDED_CARDS => [
        ...
        "updateGameProgression" => true,
        "transitions"           => ["actSelectCard" => STATE_SELECT_CARD],
    ],
    ...
    STATE_MULTIACTIVE_SKILL => [
        ...
        "possibleactions"       => [
            ...
            "actReturnOneCard",
            "actSwitchMoney",
            "actSelectCardToGiveLeft",
            "actChoseRPSOpponent",
            "actSelectRPS",
            "actCopySkill",
            "actNameCardToForcePlay",
            "actNameCardToTakeMoney",
        ],
        "transitions"           => [
            "activateSkills"                  => STATE_ACTIVATE_SKILLS,
            "multiActiveSkill"                => STATE_MULTIACTIVE_SKILL,
    ...
    STATE_END_OF_ROUND_CLEANUP => [
        ...
        "updateGameProgression" => true,
        "transitions"           => ["actSelectCard" => STATE_SELECT_CARD, "resolveRound" => STATE_RESOLVE_ROUND],
    ],
